...
import org.combinators.ctp.repositories.scene.{PolySceneCellSegmentation, PolySceneCellSegmentationCentroids}
import org.locationtech.jts.geom.{Coordinate, Triangle}

trait CmpCellCentroidsRepository2 extends CmpUtils {
